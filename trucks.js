var foodTrucks = [
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'We love pies - sweet and savory.' +
    ' We serve them up to the hungry people in' +
    ' Seattle in our fabulous food truck',
    website: 'http://www.314pieseattle.com',
    Facebook: 'https://www.facebook.com/pages/' +
    '314-PIE/341309415945288',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Serving up delicious whoopie pies,' +
    ' cakes, pies, bars, brownies, truffles, and cookies' +
    ' from Bertha Mae, our bakery-on-wheels',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Ice creams and sorbets that are intensely' +
    ' flavored and as locally sourced and seasonal as possible' +
    ' without sacrificing taste or texture. ' +
    'All from a fetching cart.',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Offsite catering from Barking Frog' +
    ' is hitting the road in style to satisfy your' +
    ' Grand Marnier Prawn craving by bringing' +
    ' (your favorite) gourmet eats to the streets!',
  ...
  },
  {
    ...
    schedule: ['Monday'],
    payment: ['Cash', 'Cards'],
    description: 'Barriga Llena was the first vendor' +
    ' to introduce traditional Mexican tortas to ' +
    'Seattle, just the way you have them ' +
    'in Mexico City',
  ...
  },
  {
    ...
    schedule: ['Tuesday',
               ...
               'Sunday'],
    payment: ['Cash', 'Cards'],
    description: 'Alaskan Reindeer Sausages ' +
    '& other gourmet and exotic ' +
  ...
  },
  {
    ...
    'made w/ natural, organic ingredients',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Bring people together using their' +
    ' sense of Filipino cuisine in a unique and' +
    ' flavorful way',
  ...
  },
  {
    ...
    type: ['Sandwiches'],
    payment: ['Cash', 'Cards'],
    description: 'Steak sandwiches, burgers, ' +
  ...
  },
  {
    name: 'Big House BBQ',
    type: ['BBQ'],
    description: 'All of Big House BBQ\'s meats ' +
    'are slow smoked using seasoned apple wood, ' +
    'and alter from the Great Northwest because ' +
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Hand made ice cream, ice cream ' +
    'sandwiches, and floats in the summer, ' +
    'hearty soups and stews in the cold, ' +
    'rainy months',
  ...
  },
  {
    ...
    schedule: ['Tuesday'],
    payment: ['Cash', 'Cards'],
    description: 'Chinese crepes, also known ' +
    'at jiangbing are a delicious traditional ' +
  ...
  },
  {
    ...
    schedule: ['Monday',
               ...
               'Friday'],
    payment: ['Cards'],
    description: 'Sweet and Savory smothered ' +
    'biscuits made with local and ' +
  ...
  },
  {
    ...
    type: ['Dessert'],
    payment: ['Cash', 'Cards'],
    description: 'Cupcakes, Gelato and Pastry ' +
    'Truck serving curbside throughout King, ' +
  ...
  },
  {
    name: 'Cake Mobile',
    type: ['Sweets'],
    description: 'Events and festivals, and parked ' +
    'at their building near the Tacoma Dome ' +
  ...
  },
  {
    ...
    schedule: ['Tuesday',
               ...
               'Thursday'],
    payment: ['Cash', 'Cards'],
    description: 'Asian Fusion, like the ' +
    'truck\'s name Chopstix. Our specialty ' +
    'is a little twist of Asian cuisine ' +
  ...
  },
  {
    ...
    type: ['Mexican'],
    payment: ['Cash', 'Cards'],
    description: 'Modern Mexican - hand made ' +
    'tortillas and gorditas, all gluten-free',
  ...
  },
  {
    ...
    schedule: ['Wednesday',
               ...
               'Sunday'],
    payment: ['Cash', 'Cards'],
    description: 'A bike-driven mobile coffee stand ' +
    'bringing manually-brewed specialty coffee' +
    ' to Seattle streets, previously ' +
    'Handlebar Coffee',
  ...
  },
  {
    ...
    schedule: ['Tuesday'],
    payment: ['Cash', 'Cards'],
    description: 'Locally sourced, in-season, ' +
    'top-shelf ingredients in exquisitely ' +
    'crafted crepes',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Savory and sweet crepes; ' +
    'breakfast, lunch and dinner; hot coffee ' +
    'and espresso drinks',
  ...
  },
  {
    ...
    schedule: ['Monday',
               ...
               'Sunday'],
    payment: ['Cash'],
    description: 'Bringing you the finest and ' +
    'most authentic of Mexican cuisine',
  ...
  },
  {
    ...
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
    payment: ['Cash', 'Cards'],
    description: 'Specializing in Gourmet Tortas, ' +
    'Tacos, Tamales (on green banana leaf) ' +
    'and Quesadillas',
  ...
  },
  {
    ...
    schedule: ['Monday',
               ...
               'Sunday'],
    payment: ['Cash'],
    description: 'Regular taco truck in the ' +
    'Fremont neighborhood - open 7 days a ' +
    'week and late night',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Gourmet hot dogs, weiners, ' +
    'sausages, hot links and more, contact ' +
    'at 425.761.9447 or franksfranks3@gmail.com',
  ...
  },
  {
    ...
    schedule: ['Sunday'],
    payment: ['Cash', 'Cards'],
    description: 'Fruit Chatter Box provides fresh,' +
    'seasonal fresh fruit in cups or on a stick at ' +
