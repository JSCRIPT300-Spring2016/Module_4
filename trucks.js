var foodTrucks = [
  {
    ...
    description: 'We love pies - sweet and savory. \
      We serve them up to the hungry \
      people in Seattle in our fabulous food truck',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Ice creams and sorbets that are intensely flavored \
      and as locally sourced and seasonal as possible without sacrificing \
      taste or texture. All from a fetching cart.',
  ...
  },
  {
    ...
    description: 'Offsite catering from Barking Frog is hitting the road in \
      style to satisfy your Grand Marnier Prawn craving by bringing \
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Alaskan Reindeer Sausages & other \
      gourmet and exotic Sausages and hotdogs',
  ...
  },
  {
    ...
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday',
      'Friday', 'Saturday', 'Sunday'],
    payment: ['Cash', 'Cards'],
    description: 'Authentic Mexican cuisine made w/ \
  ...
  },
  {
    ...
    schedule: ['Tuesday'],
    payment: ['Cash', 'Cards'],
    description: 'Chinese crepes, also known at jiangbing are a \
      delicious traditional Chinese street snack',
  ...
  },
  {
    ...
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
    payment: ['Cards'],
    description: 'Sweet and Savory smothered biscuits made with local \
  ...
  },
  {
    ...
    description: 'A bike-driven mobile coffee stand bringing \
      manually-brewed specialty coffee to Seattle streets, \
      previously Handlebar Coffee',
  ...
  },
  {
    ...
    schedule: ['Tuesday'],
    payment: ['Cash', 'Cards'],
    description: 'Locally sourced, in-season, top-shelf \
      ingredients in exquisitely crafted crepes',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Savory and sweet crepes; breakfast, lunch \
      and dinner; hot coffee and espresso drinks',
  ...
  },
  {
    ...
    payment: ['Cash'],
    description: 'Bringing you the finest and most \
      authentic of Mexican cuisine',
  ...
  },
  {
    ...
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday',
      'Friday', 'Saturday', 'Sunday'],
    payment: ['Cash'],
    description: 'Regular taco truck in the Fremont neighborhood - \
      open 7 days a week and late night',
...
function getTruck(name){
  return foodTrucks.filter(function(truck){
    return truck.name.toLowerCase() === name.toLowerCase();
  });
};
