...
var foodTrucks = [
  ...
  },
  {
    ...
    schedule: ['Tuesday', 'Wednesday', 'Thursday', 'Friday',
      'Saturday', 'Sunday'],
    payment: ['Cash', 'Cards'],
    description: 'Alaskan Reindeer Sausages & other gourmet and \
      exotic Sausages and hotdogs',
  ...
  },
  {
    ...
    description: 'All of Big House BBQ\'s meats are slow smoked using seasoned \
      apple wood, and alter from the Great Northwest because LOW and SLOW is \
      the only way to go.',
  ...
  },
  {
    ...
    Facebook: 'https://www.facebook.com/pages/Bikelava-Artisan-Peddled-\
      Baklava/246842835435535'
  },
  {
    name: 'Bing of Fire',
    type: ['Chinese Crepes'],
  ...
  },
  {
    ...
    Facebook: 'https://www.facebook.com/pages/Bite-Me-Cupcakes-Eatery/\
      210398125665053'
  },
  {
    name: 'Bomba Fusion',
  ...
  },
  {
    ...
    Facebook: 'https://www.facebook.com/pages/Crema-Creperie-Espresso-Bar/\
      303099846462139'
  },
  {
  ...
  },
  {
    ...
    Facebook: 'https://www.facebook.com/pages/Delicatessen-Montanti/\
      823352311016462'
  },
  {
...
// I had a heck of a time getting anywhere on this part and had to use a helper tool
// also known as your video recording
